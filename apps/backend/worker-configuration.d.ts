/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 36567f8595125b6370a1084d9fa5ce2f)
...
interface __BaseEnv_Env {
	...
	QUOTA_POLICY: "{\"sessionCreatesPerActorMinute\":10,\"commandsPerSessionMinute\":120,\"commandsPerTenantMinute\":600,\"deviceTicketsPerDeviceMinute\":30,\"sessionCommandCap\":10000}";
	UNATTENDED_ENABLED_TENANTS: "[\"prefix:acct-\"]" | "[\"metamind\", \"prefix:acct-\"]";
	SAFE_WRITE_REQUIRED_TENANTS: "[\"prefix:acct-\"]" | "[\"metamind\", \"prefix:acct-\"]";
	...
	SESSION: DurableObjectNamespace<import("./src/index").SessionAgent>;
	DEVICE: DurableObjectNamespace<import("./src/index").DeviceAgent>;
	TENANT_CONTROL: DurableObjectNamespace<import("./src/index").TenantDeviceCoordinator>;
	ACCOUNT_DIRECTORY: DurableObjectNamespace<import("./src/index").AccountDirectory>;
	MCP_AGENT: DurableObjectNamespace<import("./src/index").UnderstudyMcp>;
	ACCOUNT: DurableObjectNamespace<import("./src/index").AccountAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionAgent" | "DeviceAgent" | "TenantDeviceCoordinator" | "AccountDirectory" | "UnderstudyMcp" | "AccountAgent";
	}
	interface StagingEnv {
		...
		VERSION: WorkerVersionMetadata;
		QUOTA_POLICY: "{\"sessionCreatesPerActorMinute\":10,\"commandsPerSessionMinute\":120,\"commandsPerTenantMinute\":600,\"deviceTicketsPerDeviceMinute\":30,\"sessionCommandCap\":10000}";
		UNATTENDED_ENABLED_TENANTS: "[\"prefix:acct-\"]";
		SAFE_WRITE_REQUIRED_TENANTS: "[\"prefix:acct-\"]";
		AUTH_HMAC_SECRET: string;
		CALLER_TOKENS: string;
		EXTENSION_TOKENS: string;
		DEVICE_TOKENS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QUOTA_POLICY" | "UNATTENDED_ENABLED_TENANTS" | "SAFE_WRITE_REQUIRED_TENANTS" | "AUTH_HMAC_SECRET" | "CALLER_TOKENS" | "EXTENSION_TOKENS" | "DEVICE_TOKENS" | "EXTENSION_ID" | "WS_TICKET_SECRET">> {}
}
